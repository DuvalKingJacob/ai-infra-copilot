...
The old workflow is represented by three root modules:
...
- EKS outputs must be passed to the app workspace.
...
> If this app change depends on the EKS cluster and VPC, what else is in the blast radius?
